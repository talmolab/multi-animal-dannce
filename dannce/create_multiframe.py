...
# NUM_FRAMES = 100
NUM_INSTANCES = 1
SAVE_DIR = "/home/jovyan/vast/ckapoor/keypoint-tracking/slap_2m_sample_multi_frame_single_instance_white_mouse"
...
USE_FRAMES = [random.randint(0, 8000) for _ in range(500)]
...
def grab_poses(
    ...
    for cam in CAM_VIEWS:
        ...
        label_dict["frame_idx"] = frame  # np.array(frame)
...
def create_subset(save_dir: str):
    ...
    while gt_attempts != NUM_FRAMES:
        ...
        # session_path = generate_session(debug=True)
        # session_path = '/home/jovyan/talmolab-smb/eric/slap_2m/2022-10-30/10302022010116/'
        session_path = (
            "/home/jovyan/talmolab-smb/eric/slap_2m/2022-10-07/10072022205445/"
        )
        ...
        save_poses(
            label_dict=label_dict, session=session_name, frame=USE_FRAMES[gt_attempts]
        )
        ...
        pbar.update(1)
        # except:
        #    print(f'session: {session_path} does not have GT, searching for next session')
